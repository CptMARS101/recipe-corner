    ...
    return(
        ...
        <h1 id="Title">Recipe Corner</h1>
            <p className="intro">
                ...
                <br />
                Feel free to explore the <a href="http://localhost:3001/recipes">cookbook</a> or sign up to add a new recipe on the <a href="http://localhost:3001/form">FORM</a> page!  
            </p>
        </div>
    )
}
